module github.com/Omarabdul3ziz/tfgrid-debugging-tools/rmb-peer

go 1.22.7

require (
	github.com/Omarabdul3ziz/tfgrid-debugging-tools/utils v0.0.0-20241119233413-beaf0a2d268a
